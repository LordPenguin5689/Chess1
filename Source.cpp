...
public:
	...
	BoardSetup() {
		...
		{"White Rook", "White Knight", "Whtie Bishop", "Black Queen", "Black King", "Black Bishop", "Black Knight", "Black Rook"}
		};
	}
...
class PossibleMoves {
	public:
		...
		PossibleMoves(int key, char colour, int xPosition, int yPosition, string board[8][8]) {
			...
			//The next piece to do is the rook, starting with white. Still don't want to do knight even though it is just 4 if statements.
			if (key == 3 && colour == 'w') 
			{
...
int main() {
	BoardSetup StartFromPosition("1k1r4 / 1q6 / 1n3bn1 / 3p4 / 5P2 / 1R1NP3 / 2BP4 / 1K6 w - - 0 1");
